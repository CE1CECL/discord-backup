                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                                                            ...
                                                            return [4 /*yield*/, (0, node_fetch_1.default)(a.url).then(function (res) { return res.buffer(); })];
                                                        case 1:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    var _this = this;
                    return __generator(this, function (_a) {
                        loadMessages = function (channel, messages) {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        if (!(channelData.threads.length > 0)) return [3 /*break*/, 3];
                                        ...
                                        return [4 /*yield*/, Promise.all(channelData.threads.map(function (threadData) { return __awaiter(_this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
                                                    return [2 /*return*/, channel.threads
                                                            .create({
                                    ...
                                    case 2:
                                        ...
                                        _a.label = 3;
                                    case 3:
                                        if (!(channelData.messages.length > 0)) return [3 /*break*/, 5];
