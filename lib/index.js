        ...
        return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            files = _a.sent();
                            file = files.filter(function (f) { return f.split('.').pop() === 'json'; }).find(function (f) { return f === "".concat(backupID, ".json"); });
                            if (file) {
                                backupData = require("".concat(backups).concat(path_1.sep).concat(file));
    ...
    return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            getBackupData(backupID)
                ...
                var size = (0, fs_1.statSync)("".concat(backups).concat(path_1.sep).concat(backupID, ".json")).size; // Gets the size of the file using fs
                var backupInfos = {
                    data: backupData,
                    id: backupID,
        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_j) {
                        switch (_j.label) {
                            case 0:
                                intents = new fosscord_js_1.Intents(guild.client.options.intents);
                            ...
                            case 1:
                                ...
                                backupData = {
                                    ...
                                    guildID: guild.id,
                                    id: (_h = options.backupID) !== null && _h !== void 0 ? _h : fosscord_js_1.SnowflakeUtil.generate(Date.now())
                                };
                                if (!guild.iconURL()) return [3 /*break*/, 4];
                                if (!(options && options.saveImages && options.saveImages === 'base64')) return [3 /*break*/, 3];
                                _a = backupData;
                                return [4 /*yield*/, (0, node_fetch_1.default)(guild.iconURL({ dynamic: true })).then(function (res) { return res.buffer(); })];
                            case 2:
                            ...
                            case 4:
                                ...
                                _b = backupData;
                                return [4 /*yield*/, (0, node_fetch_1.default)(guild.splashURL()).then(function (res) { return res.buffer(); })];
                            case 5:
                            ...
                            case 7:
                                ...
                                _c = backupData;
                                return [4 /*yield*/, (0, node_fetch_1.default)(guild.bannerURL()).then(function (res) { return res.buffer(); })];
                            case 8:
                            ...
                            case 18:
                                ...
                                // Save the backup
                                return [4 /*yield*/, writeFileAsync("".concat(backups).concat(path_1.sep).concat(backupData.id, ".json"), backupJSON, 'utf-8')];
                            case 19:
                                // Save the backup
                                _j.sent();
                                _j.label = 20;
...
var remove = function (backupID) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve, reject) {
                try {
                    require("".concat(backups).concat(path_1.sep).concat(backupID, ".json"));
                    (0, fs_1.unlinkSync)("".concat(backups).concat(path_1.sep).concat(backupID, ".json"));
                    resolve();
                }
                catch (error) {
