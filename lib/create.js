                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            _a = eData;
                            return [4 /*yield*/, (0, node_fetch_1.default)(emoji.url).then(function (res) { return res.buffer(); })];
                        case 1:
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0:
                                ...
                                categories = guild.channels.cache.filter(function (ch) { return ch.type === 'GUILD_CATEGORY'; })
                            ...
                            case 2:
                                ...
                                return [4 /*yield*/, (0, util_1.fetchTextChannelData)(child, options)];
                            case 3:
                                channelData = _c.sent();
                                categoryData.children.push(channelData); // And then push the child in the categoryData
                                return [3 /*break*/, 6];
                            case 4: return [4 /*yield*/, (0, util_1.fetchVoiceChannelData)(child)];
                            case 5:
                                channelData = _c.sent();
                                categoryData.children.push(channelData); // And then push the child in the categoryData
                                _c.label = 6;
                            ...
                            case 9:
                                others = guild.channels.cache.filter(function (ch) {
                                    return (!ch.parent &&
                                        ...
                                        ch.type !== 'GUILD_PUBLIC_THREAD'); // threads will be saved with fetchTextChannelData
                                })
                                    .sort(function (a, b) { return a.position - b.position; })
                                    .toJSON();
                            ...
                            case 10:
                                ...
                                return [4 /*yield*/, (0, util_1.fetchTextChannelData)(channel, options)];
                            case 11:
                                channelData = _c.sent();
                                channels.others.push(channelData); // Update channels object
                                return [3 /*break*/, 14];
                            case 12: return [4 /*yield*/, (0, util_1.fetchVoiceChannelData)(channel)];
                            case 13:
                                channelData = _c.sent();
                                channels.others.push(channelData); // Update channels object
                                _c.label = 14;
